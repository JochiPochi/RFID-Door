 ...
 * Version: 3.0
 * Notes: Full blown thing maybe, it works with all cards
 *        The auto save has not been implemented but 
 *        this version has been working for a couple of
 *        months allready so I can say it works pretty well
 *******************************************************/
